...
function WaitForConfigForm({
  defaultConfig = { selector: '', timeout: '' },
  onConfigChange,
}) {
...
function WaitForTimeoutConfigForm({
...
function SelectOptionConfigForm({
  defaultConfig = { selector: '', value: '' },
  onConfigChange,
}) {
  const [config, setConfig] = useState(defaultConfig);
...
function LoopClickConfigForm({
  defaultConfig = { selector: '', waitTime: '' },
  onConfigChange,
}) {
  const [config, setConfig] = useState(defaultConfig);
