    ...
    <div className="font-sans grid items-center justify-items-center p-8 pb-20 sm:p-20">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start w-full">
        <div className="w-full justify-items-center">
          {' '}
          <h2 className="text-2xl font-bold">导出条目 </h2>
        </div>
                ...
                <TableRow>
                  {exportFields.map((exportField, index) => (
                    <TableHead
                      ...
                      className={
                        index > 2
                          ? 'w-64 whitespace-break-spaces break-all hidden'
                          : 'w-64 whitespace-break-spaces break-all'
                      }
                    >
                      {exportField}
                    </TableHead>
