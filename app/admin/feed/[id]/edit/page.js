...
import { FeedConfigForm } from '@/components/feed-config-form';
...
export default function FeedEditPage() {
  ...
  const removeFields = async (index, e) => {
    e.preventDefault();
      ...
      <main className="">
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-xl"> 编辑种子 </CardTitle>
          </CardHeader>
          <CardContent>
            <form>
              <FieldGroup>
                    ...
                    <SelectContent>
                      <SelectGroup>
                        {data.intervalOptions.map((intervalOption, index) => (
                          <SelectItem key={index} value={intervalOption.key}>
                    ...
                    <SelectContent>
                      <SelectGroup>
                        {data.gradeOptions.map((gradeOption, index) => (
                          <SelectItem key={index} value={gradeOption.key}>
                            {gradeOption.label}
                          </SelectItem>
                        ))}
                      </SelectGroup>
                ...
                {loaded && !item.useTemplate && (
                  <FeedConfigForm feedConfig={item.config} ref={childRef} />
                )}
