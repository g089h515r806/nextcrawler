                ...
                {logs.map((row) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell className="w-128 whitespace-break-spaces break-all">
                      <p className="break-normal">{row.message}</p>
                    </TableCell>
                    <TableCell>
                      <Link href={'/admin/log/' + row.id + ''}>查看</Link>
                    </TableCell>
                    <TableCell>
                      <Link href={'/admin/log/' + row.id + '/delete'}>
                        删除
                      </Link>
                    </TableCell>
                  </TableRow>
          ...
          {logs.length == 0 && (
            <Empty>
              <EmptyHeader>
                ...
                <EmptyDescription>现在还没有创建任何日志.</EmptyDescription>
              </EmptyHeader>
