            ...
            <TabsContent value="cron">
              <Card>
                <CardContent className="grid gap-6">
                  <FieldGroup>
                    <Field>
                      <FieldLabel htmlFor="limitNumFeed">
                        每次采集种子数量
                      </FieldLabel>
                      <Input
                        id="limitNumFeed"
                    ...
                    <Field>
                      <div className="flex items-center">
                        <FieldLabel htmlFor="limitNumListPage">
                          每次采集分页数量
                        </FieldLabel>
                      </div>
                      <Input
                        id="limitNumListPage"
                        name="limitNumListPage"
                        type="number"
                        value={item.limitNumListPage}
                        onChange={handleChange}
                        required
                      />
                    </Field>
                    ...
                    <Field>
                      <div className="flex items-center">
                        <FieldLabel htmlFor="limitNumItem">
                          每次采集条目数量
                        </FieldLabel>
                      </div>
                      <Input
                    ...
                    <div className="flex items-start gap-3">
                      <Checkbox
                        id="useCronJob"
                        name="useCronJob"
                        checked={item.useCronJob}
                        onCheckedChange={handleUseCronJobChange}
                      />
            ...
            <TabsContent value="browser">
              <Card>
                <CardContent className="grid gap-6">
                  ...
                  <div className="flex items-start gap-3">
                    <Checkbox
                      id="usePersistentContext"
                      name="usePersistentContext"
                      checked={item.usePersistentContext}
                      onCheckedChange={handleUsePersistentContextChange}
                    />
                    <div className="grid gap-2">
                      <Label htmlFor="usePersistentContext">
                        使用持久化上下文(Persistent Context)
                      </Label>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <Field>
                    <FieldLabel htmlFor="userDataDir">
                      用户数据目录(userDataDir)
                    </FieldLabel>
                    <Input
                      id="userDataDir"
